...
#
	...
	close(FH);
	system("rm $exc_dir/Working_dir/zdump");
...
#
	system("/home/ascds/DS.release/bin/flt_run_pipe -i $exc_dir/Temp_comp_area  -o $exc_dir/Temp_comp_area  -r zcomp -t mta_monitor_cti.ped -a \"genrpt=yes\"");

	system("rm $exc_dir/Working_dir/$out_file");
#
...
#
	...
	close(FH);
	system("rm $exc_dir/Temp_comp_area/z*");
	system("rm $exc_dir/Temp_comp_area/*.fits");
	system("rm mta_cti*");
...
system("rm -rf $exc_dir/Temp_comp_area");
